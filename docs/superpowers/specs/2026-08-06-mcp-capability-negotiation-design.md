...
> ↩ **[Change 0019 — MCP capability negotiation — structured init handshake](https://github.com/ethanhinson/fuse/blob/docket/docs/changes/archive/2026-08-07-0019-mcp-capability-negotiation.md)**
<!-- docket:backlink:end -->
