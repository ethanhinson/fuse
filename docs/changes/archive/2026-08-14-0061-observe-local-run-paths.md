...
results: docs/results/2026-08-14-observe-local-run-paths-results.md
trivial: false
auto_groomable:
...
| Plan | [2026-08-14-observe-local-run-paths-plan.md](https://github.com/ethanhinson/fuse/blob/main/docs/superpowers/plans/2026-08-14-observe-local-run-paths-plan.md) |
| Results | [2026-08-14-observe-local-run-paths-results.md](https://github.com/ethanhinson/fuse/blob/main/docs/results/2026-08-14-observe-local-run-paths-results.md) |
| PR | [#59](https://github.com/ethanhinson/fuse/pull/59) |
| ADRs | [ADR-0040](https://github.com/ethanhinson/fuse/blob/docket/docs/adrs/0040-provider-neutral-composite-observer.md), [ADR-0042](https://github.com/ethanhinson/fuse/blob/docket/docs/adrs/0042-local-run-paths-adapt-observability-io.md) |
