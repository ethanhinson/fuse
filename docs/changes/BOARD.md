...
**39 changes** — ⚪ 1 deferred · 🔵 1 implemented · ✅ 31 done · 🗑️ 6 killed
...
|---|-------|----------|------|----|-----------|
| [0030](active/0030-segment-store.md) | Segment store — pre-compaction transcript archive for replay | `low` | `feat` | [#41](https://github.com/ethanhinson/fuse/pull/41) |  |
