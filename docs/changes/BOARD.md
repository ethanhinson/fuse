...
**39 changes** — 🟡 16 proposed · ✅ 19 done · 🗑️ 4 killed
...
| [0034](active/0034-workflows.md) | Workflows — skill-bound subagent pools with typed workers and spawn quotas | `high` | `feat` | build-ready |
