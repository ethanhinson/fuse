...
**39 changes** — 🟢 1 in progress · 🟡 15 proposed · ✅ 19 done · 🗑️ 4 killed

## 🟢 In progress (1)

| # | Title | Priority | Type | Spec | Branch |
|---|-------|----------|------|------|--------|
| [0034](active/0034-workflows.md) | Workflows — skill-bound subagent pools with typed workers and spawn quotas | `high` | `feat` | [spec](../superpowers/specs/0034-workflows.md) | `feat/workflows` |
