...
**71 changes** — 🟢 1 in progress · 🟡 4 proposed · ⚪ 2 deferred · ✅ 58 done · 🗑️ 6 killed

## 🟢 In progress (1)

| # | Title | Priority | Type | Spec | Branch |
|---|-------|----------|------|------|--------|
| [0069](active/0069-auto-mode-classifier-retune-webfetch.md) | Auto-mode classifier retune + web_fetch loosening — allow-bias for routine dev ops, seed becomes real auto-approve | `medium` | `feat` | [spec](../superpowers/specs/2026-08-17-auto-mode-classifier-retune-webfetch-design.md) | `feat/auto-mode-classifier-retune-webfetch` |
