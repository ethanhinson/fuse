.PHONY: build install egress-forwarder egress-datapath test test-race lint test-integration test-k8s proto sdk-ts-test browser-test observability-validate observability-acceptance observability-race observability-compose-smoke
